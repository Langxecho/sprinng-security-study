    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/spring_security?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&autoReconnect=true",
                ...
                .globalConfig(builder -> {
                    // 设置作者
                    builder.author("langxecho")
                            // 覆盖已生成文件
                            .fileOverride()
                            // 指定 Java 代码输出目录
                            .outputDir("F:\\CodeProject\\sprinng-security-study");
                })
                .packageConfig(builder -> {
                    // 设置父包名
                    builder.parent("top.langxecho")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "F:\\CodeProject\\sprinng-security-study\\2-auth-database\\src\\main\\resources\\mapper")); // 设置 mapperXml 生成路径
                })
